...
interface LocationJumpTableComponentProps {
...
const LocationJumpTableComponent = ({
  ...
  return (
    <div className="w-full h-full flex flex-col justify-between items-center">
      <div className="header w-full h-[28px] text-[12px] flex items-center px-[10px] text-[#FB685C] font-semibold border-b-[2px] border-solid border-[#FB685C]/30 bg-gradient-to-r from-transparent via-[#FB685C]/5 to-transparent">
        地点名称
      </div>
